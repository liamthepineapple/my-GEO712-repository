...
This readme document is stored in an R project structure titled "Activity2." In this project structure, there are a number of folders and files:

1. The `renv` folder stores the respective R packages and their versions for this project. 
1. The `images` folder contains any relevant images for the project and any inserted images will be stored and pulled from this folder. 
